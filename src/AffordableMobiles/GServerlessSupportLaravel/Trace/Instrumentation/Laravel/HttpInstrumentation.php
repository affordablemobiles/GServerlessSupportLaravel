...
class HttpInstrumentation
{
    public static function register(CachedInstrumentation $instrumentation): void
    {
        hook(
            ...
            post: static function (Kernel $kernel, array $params, ?Response $response, ?\Throwable $exception): void {
                ...
                if ($response) {
                    ...
                    // Propagate X-Cloud-Trace-Context header to response
                    Globals::propagator()->inject($response, ResponsePropagationSetter::instance(), $scope->context());
                }
